package com.coding.maintenancehouse.practitioner.adapters;
...
public class PractitionerHomeAdapter extends RecyclerView.Adapter<PractitionerHomeAdapter.HomeViewHolder> {
    ...
    public PractitionerHomeAdapter(Context context, List<OrderModel> orderModelList) {
    ...
    public void onBindViewHolder(@NonNull HomeViewHolder holder, int position) {
        ...
        if (orderModel.getUrgent()){
            holder.urgentText.setVisibility(View.VISIBLE);
        }
    }
    ...
    public  class HomeViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public HomeViewHolder(@NonNull View itemView) {
            ...
            urgentText = itemView.findViewById(R.id.urgentText);
